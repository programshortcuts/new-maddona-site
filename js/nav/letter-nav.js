...
export function initLetterNav({
    ...
    document.addEventListener('keydown', (e) => {
        ...
        const selectors = 'ul > li > a, .page-title, img, iframe, .section-title, #mdvipImgLink, #navBarBtn, #madonnaMedSpa-address-header, .more-info-links > button, .letter-alphabet, .product-title, .item, #instagramLogo, #facebookLogo';
